    ...
    <div class="container">
        <div class="row section-body">
            ...
            <div class="col-md-4 footer-box">
                ...
                <p><i class="fas fa-map-marker-alt" />{ADDRESS}</p>
                <p><i class="fas fa-phone" />{MOBILE}</p>
                <p><i class="fas fa-envelope" />{EMAIL}</p>
            </div>
            <div class="col-md-4 footer-box">
                <p class="footer-title">{SUBSCRIBE_NEWSLETTER}</p>
                <input type="email" class="form-control round-border" placeholder="Your Email" />
                <button class="btn btn-outline-light round-border">{SUBSCRIBE}</button>
            </div>
        </div>
    </div>    
</section>
